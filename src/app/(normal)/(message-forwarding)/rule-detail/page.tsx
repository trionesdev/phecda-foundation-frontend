...
import { ForwardingRuleForm } from '@/app/(normal)/(message-forwarding)/rule/forwarding-rule-tab/ForwardingRuleForm';
import { SourceStep } from '@/app/(normal)/(message-forwarding)/rule-detail/SourceStep';
import { SinkStep } from '@/app/(normal)/(message-forwarding)/rule-detail/SinkStep';
